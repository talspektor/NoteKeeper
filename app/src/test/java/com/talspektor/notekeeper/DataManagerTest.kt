...
class DataManagerTest {
    ...
    fun findSimilarNotes() {
        val course = DataManager.courses["android_async"]!!
        val noteTitle = "This is a test note"
        val noteTest1 = "This is the body of my test note"
        val noteText2 = "This is the bodu of my second test note"

        val index1 = DataManager.addNote(course, noteTitle, noteTest1)
        val index2 = DataManager.addNote(course, noteTitle, noteText2)

        val note1 = DataManager.findNote(course, noteTitle, noteTest1)
